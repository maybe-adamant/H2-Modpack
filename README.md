...
* **Echo scam gone:** You will no longer get Echo scammed. Mod will now prevent one of the minibosses at random from spawning at room 3 in the field and thus ensuring that Echo always appear. However, to balance it, I've restored the chance for the shop to appear. Now it is a 50/50 chance for echo/shop room. Similar to how Circe/Midshop work in Thessaly.
* **Less Sucky Surface:** Three adjustments to the Surface: 1-Thessaly minibosses are forced to appear between rooms 2 and 4 (consistent with other biomes). 2-the Olympus mid-shop is forced to appear between rooms 3 and 5 (consistent with the Oceanus mid-shop). 3-Hercales cannot spawn on Thessaly anymore.
...
* **Miniboss Encounter Fix:** Boar, Charybdis, Talos, and Typhon Eye/Arm encounters now correctly count toward room encounter depth.
